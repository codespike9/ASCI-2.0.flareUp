...
class SigninStartupScreen extends StatefulWidget {
  const SigninStartupScreen({super.key});
  static const String routeName = '/startup-signin-screen';

  @override
  State<SigninStartupScreen> createState() => _SigninStartupScreenState();
}

class _SigninStartupScreenState extends State<SigninStartupScreen> {
              ...
              ? Container(
                  decoration: BoxDecoration(
                      gradient: const LinearGradient(colors: [
                        Color.fromARGB(255, 251, 201, 126),
                        Color.fromARGB(255, 232, 79, 77)
